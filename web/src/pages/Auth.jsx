          ...
          <div className="w-full flex flex-col gap-4">
            ...
            {showLogin && (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full text-white bg-indigo-700 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center tracking-tight"
                >
                  Sign in
                </button>
              </form>
            ...
            {!showLogin && (
              ...
              >
                ...
                <div>
                  <label className="block mb-2 text-sm font-medium text-white">
                    Password <span className="text-indigo-500 text-xl">*</span>
                  </label>
                  <input
                    type="password"
                    name="password"
            ...
            <p className="text-sm font-light text-gray-500">
              ...
              <button
                className="pl-1 font-medium text-indigo-500 underline underline-offset-2"
                onClick={toggleForm}
              >
