...
import { createTrack, fetchTracksByUserId } from "../../../redux/tracks/reducer"
          ...
          <div className="w-full flex flex-row justify-end items-center gap-8">
            ...
            <div className="flex flex-row items-start gap-8">
              <div className="flex flex-col items-start">
                ...
                <time className="-mt-1 text-lg text-gray-500 font-bold">{dateToday}</time>
              </div>
              <div className="flex flex-col items-start">
                <span className="text-xs text-gray-400">Time starts at</span>
                <time className="-mt-1 text-lg text-gray-500 font-bold">{currentTime}</time>
              </div>
            </div>
            <button
              type="submit" 
